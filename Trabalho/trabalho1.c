...
int main()
{
    ...
    do{
        ...
        case 1:
            ...
            printf("\nEm razao a sua Assistente Virtual de Luxo, estou aqui para te ajudar a escolher um tipo de bebida para suas comemoracoes e interesses pessoais!");
            ...
            if (strcmp(inicio, "NAOALCOLICA") == 0){
                ...
                do{
                    ...
                    if(strcmp(bebidaBase, "LEVE") != 0 && strcmp(bebidaBase, "SABOR") != 0){
                        printf("\nInsira uma preferencia de bebida válida entre (LEVE e SABOR): \n");
                    }
                    // Verifica se a entrada é válida
                ...
                if (strcmp(bebidaBase, "LEVE") == 0){
                    ...
                    printf("\nTomar um drink leve - Agua de Coco com Limao\n");
                } else {
                    printf("\nDe acordo com suas escolhas acredito que a escolha ideal seria: ");
                    printf("\nTomar um drink sem alcool, mas saboroso - Refri com Limao ou Soda Italiana\n");
                }
            } else {
                // Bebidas alcoólicas
                printf("\n Muito bom! Voce escolheu bebidas alcoolicas! \n");
                printf("\nInsira abaixo sua preferencia de bebida entre DRINKS ou TRADICIONAIS: (DRINKS, TRADICIONAIS)\n");
